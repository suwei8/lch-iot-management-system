...
let PermissionsGuard = class PermissionsGuard {
    ...
    canActivate(context) {
        ...
        const hasAllPermissions = requiredPermissions.every((permission) => (0, permissions_decorator_1.hasPermission)(user.role, permission));
        if (!hasAllPermissions) {
            throw new common_1.ForbiddenException('权限不足，无法执行此操作');
        }
        return true;
    }
};
